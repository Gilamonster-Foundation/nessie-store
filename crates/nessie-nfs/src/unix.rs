...
//!
//! This module is compiled only on `#[cfg(unix)]`; the crate root provides a
//! non-Unix `serve` stub. (Crate-level `forbid(unsafe_code)` / `deny(missing_docs)`
//! live in `lib.rs` and cover this module.)
